...
/// NOTE: Don't change the order of Device Size
enum DEVICES {
  XS,
  SM,
  MD,
...
DEVICES getDeviceFromPrefixString(String prefixString) {
  switch (prefixString) {
    case 'xl':
      return DEVICES.XL;
    case 'lg':
...
///
class CustomBootstrapContainer extends StatelessWidget {
  CustomBootstrapContainer({
    Key? key,
...
///
/// A [CustomBootstrapRow] may only contain [CustomBootstrapCol] children.
///
class CustomBootstrapRow extends StatelessWidget {
  CustomBootstrapRow({
    required this.children,
    this.decoration,
    this.height,
  ...
  ///
  /// List of the children of type [CustomBootstrapCol]
  ///
  final List<CustomBootstrapCol> children;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        //
        List<CustomBootstrapCol> _children = List.from(children);
        _children.sort(
...
///
class CustomBootstrapCol extends StatelessWidget {
  CustomBootstrapCol({
    required this.child,
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        Widget widget = Container(
          ...
          ///commenting to remove padding between the columns -- align_with
          // Padding(
...
/// defined in [sizes]
///
class CustomBootstrapVisibility extends StatelessWidget {
  CustomBootstrapVisibility({
    required this.child,
    String sizes = "",
  }) : this.sizes = sizes.trim() {
    _initialize();
